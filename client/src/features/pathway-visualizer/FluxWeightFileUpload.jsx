...
function FluxWeightFileUpload({
    isOpenFluxWeightFileModal,
    ...
    return (
        <Dialog
            open={isOpenFluxWeightFileModal}
            onClose={() => {}}
                    ...
                    <div>
                        <div className="flex items-center justify-between">
                            <Dialog.Title className="text-sm font-semibold">
                                Upload Flux Weight File
                            </Dialog.Title>
                            <button
                                onClick={() => {
                                    setIsOpenFluxWeightModal(false)
                        ...
                        <p className="my-1 text-sm text-gray-600">
                            Upload a flux weight file (.csv) that contains two
                            columns (reactions, weights). Also note that the
                            weights will be applied to only enzymes and any
                            enzyme without any weight will be assigned to `NOT
                            ASSIGNED`
                        </p>
                    </div>
                    ...
                    {step === 'loading' && (
                        <div className="flex flex-col items-center justify-center py-4">
                            ...
                            <p className="mt-4 text-sm text-gray-600">
                                Flux Weight File Uploaded ✅. Applying weights.....
                            </p>
                        </div>
                    )}
                    {step === 'done' && (
...
export default FluxWeightFileUpload
